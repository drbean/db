use utf8;
package DB::Schema::Result::MdlQtypeDdmarker;
...
DB::Schema::Result::MdlQtypeDdmarker
...
=head1 TABLE: C<mdl_qtype_ddmarker>

=cut

__PACKAGE__->table("mdl_qtype_ddmarker");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'mdl_qtype_ddmarker_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:H3KoQ629KjjGWQwxnFAVRQ
