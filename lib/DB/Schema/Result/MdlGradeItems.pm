use utf8;
package DB::Schema::Result::MdlGradeItems;
...
DB::Schema::Result::MdlGradeItems
...
=head1 TABLE: C<mdl_grade_items>

=cut

__PACKAGE__->table("mdl_grade_items");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'mdl_grade_items_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sIfwaE0ozNA8WesQHCI69A
