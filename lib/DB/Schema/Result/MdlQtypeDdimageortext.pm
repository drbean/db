use utf8;
package DB::Schema::Result::MdlQtypeDdimageortext;
...
DB::Schema::Result::MdlQtypeDdimageortext
...
=head1 TABLE: C<mdl_qtype_ddimageortext>

=cut

__PACKAGE__->table("mdl_qtype_ddimageortext");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'mdl_qtype_ddimageortext_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sCS8+TNg8J5daeIIrUpB+g
